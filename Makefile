...
all: index.html about.html projects.html contact.html
	rm -f *.mustache

index.html: $(CONTENT_DIR)/index.yml $(TEMPLATE_DIR)/index.mustache $(HEADFOOT)
	$(call MUSTACHE,index.yml,index.mustache,headfootPart.mustache)
